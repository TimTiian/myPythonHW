...
def show_start_interface(screen, width, height):
        ...
        cfont = pygame.font.Font('./font/simkai.TTF', width//30)
        title = tfont.render('TANK '+ '1994', True, (255, 0, 0))
        content1 = cfont.render(u'Press 1 to enter the single player game', True, (255, 255, 255))
        content2 = cfont.render(u'Press 2 to enter the double player game', True, (255, 255, 255))
...
def show_end_interface(screen, width, height, is_win):
        ...
        if is_win:
            ...
            content = font.render(u'Congratulations to customs clearance！', True, (255, 0, 0))
                    ...
                    if each.born:
                        if each.times > 0:
                            ...
                            if each.times <= 10:
                                ...
                                screen.blit(appearances[1], (33+each.x * 12 * 24, 3))
                            elif each.times <= 90:
                                screen.blit(appearances[0], (3+each.x * 12 * 24, 3))
                        else:
                            each.born = False
