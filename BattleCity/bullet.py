...
class Bullet(pygame.sprite.Sprite):
	def __init__(self):
		...
		# Bullets in four directions (up, down, left, right)
		self.bullets = ['./images/bullet/bullet_up.png', './images/bullet/bullet_down.png', './images/bullet/bullet_left.png',
						'./images/bullet/bullet_right.png']
		# Bullet direction (default upward)
		self.direction_x, self.direction_y = 0, -1
		self.bullet = pygame.image.load(self.bullets[0])
		self.rect = self.bullet.get_rect()
		# Assign the actual value in the tank class
		self.rect.left, self.rect.right = 0, 0
		# speed
		self.speed = 4
		# Whether to live
		self.being = False
		# Is it a reinforced bullet (breakable steel plate)？
		self.stronger = False
	# Deflect a bullet
	...
	def move(self):
		...
		# Disappear at the edge of the map
